...
def test_json_verification_success():
    """Test that JSON verification passes when JMESPath expressions match expected values."""
    responses.add(
        responses.GET,
        "https://api.example.com/users",
...
def test_json_verification_failure():
    """Test that JSON verification fails when JMESPath expressions don't match expected values."""
    responses.add(
        responses.GET,
        "https://api.example.com/users",
...
def test_json_verification_with_different_data_types():
    """Test JSON verification with different data types."""
    responses.add(
        responses.GET,
        "https://api.example.com/test",
        json={
...
def test_json_verification_with_status_check():
    """Test JSON verification combined with status verification."""
    responses.add(
        responses.GET,
        "https://api.example.com/users",
        json={"users": [{"id": 1, "name": "John"}], "total": 1},
...
def test_json_verification_with_response_headers():
    """Test JSON verification that checks response headers."""
    responses.add(
        responses.GET,
        "https://api.example.com/test",
        json={"test": "data"},
...
def test_json_verification_error_handling():
    """Test error handling for invalid JMESPath expressions during verification."""
    responses.add(
        responses.GET,
        "https://api.example.com/test",
        json={"test": "data"},
...
def test_json_verification_without_json_field():
    """Test that stages without json verification work normally."""
    responses.add(
        responses.GET,
        "https://api.example.com/test",
        json={"test": "data"},
...
def test_json_verification_multiple_stages():
    """Test JSON verification across multiple stages."""
    responses.add(
        responses.GET,
        "https://api.example.com/users",
        json={"users": [{"id": 1, "name": "John"}], "total": 1},
