...
def test_parametrize_individual(pytester):
    ...
    result = run_scenario(pytester, "parametrize/test_parametrize_individual.http.json")
...
def test_parametrize_combinations(pytester):
    ...
    result = run_scenario(pytester, "parametrize/test_parametrize_combinations.http.json")
...
def test_parametrize_multiple(pytester):
    ...
    result = run_scenario(pytester, "parametrize/test_parametrize_multiple.http.json")
