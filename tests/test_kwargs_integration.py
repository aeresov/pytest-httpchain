...
class TestFunctionCallModel:
    ...
    def test_function_call_model(self, kwargs, expected_kwargs):
...
class TestVerifyModel:
    def test_verify_with_function_call(self):
        verify = Verify(
            status=200,
            functions=[
...
class TestSaveConfigModel:
    def test_save_config_with_function_call(self):
...
class TestStageModel:
    def test_stage_with_function_calls(self):
        stage = Stage(
            name="test_stage",
...
class TestScenarioModel:
    ...
    def test_scenario_with_function_calls(self, scenario_data, expected_verify, expected_save):
    ...
    def test_mixed_function_formats(self):
        scenario_data = {
            "stages": [
                {
                    "name": "test_stage",
...
class TestKwargsSubstitution:
    ...
    def test_substitute_kwargs_variables(self, kwargs, variables, expected):
        result = substitute_kwargs_variables(kwargs, variables)
        assert result == expected

    def test_substitute_kwargs_variables_none(self):
        result = substitute_kwargs_variables(None, {"var": "value"})
        assert result is None

    def test_substitute_kwargs_variables_nested(self):
        kwargs = {
    ...
    def test_substitute_kwargs_variables_complex_json(self):
        kwargs = {
            "config": {
                "filters": [
...
class TestPluginKwargsFunctionality:
    def test_call_function_with_kwargs(self, mock_response):
    ...
    def test_call_function_with_kwargs_error_handling(self, mock_response, error_type, expected_message):
        with patch('importlib.import_module') as mock_import:
    ...
    def test_function_validation_with_kwargs(self, function_name, should_raise, expected_error):
