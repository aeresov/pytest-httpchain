# pytest-httpchain-mcp (deprecated placeholder)
...
(the former content lives at `pytest_httpchain.mcp` where applicable).

The original `pytest-httpchain-mcp` releases were deleted from PyPI; this placeholder
