# pytest-httpchain-userfunc (deprecated placeholder)
...
(the former content lives at `pytest_httpchain.userfunc` where applicable).

The original `pytest-httpchain-userfunc` releases were deleted from PyPI; this placeholder
