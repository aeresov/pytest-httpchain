# pytest-httpchain-core (deprecated placeholder)
...
(the former content lives at `pytest_httpchain.core` where applicable).

The original `pytest-httpchain-core` releases were deleted from PyPI; this placeholder
