# pytest-httpchain-templates (deprecated placeholder)
...
(the former content lives at `pytest_httpchain.templates` where applicable).

The original `pytest-httpchain-templates` releases were deleted from PyPI; this placeholder
